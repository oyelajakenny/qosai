          ...
          >
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-surface-500 mt-2">
                Be specific for better results. For example, "React Hooks"
                ...
                <button
                  ...
                  className={`px-4 py-3 rounded-xl border text-sm font-medium transition-all duration-200 ${
                    formData.category === cat
                      ? "bg-accent-500/20 border-accent-500 text-surface-900"
            ...
            <div className="space-y-3 mb-6">
              {difficulties.map((diff) => (
                <button
                  key={diff.value}
                  onClick={() =>
                    setFormData({ ...formData, difficulty: diff.value as any })
                  }
